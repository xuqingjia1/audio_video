...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/ffmpeg --enable-shared --disable-static --enable-gpl --enable-nonfree --enable-libfdk-aac --enable-libx264 --enable-libx265
...
CC_IDENT=Apple clang version 12.0.0 (clang-1200.0.32.28)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=gcc
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-framework Foundation -lm -framework AVFoundation -framework CoreVideo -framework CoreMedia -pthread -framework CoreGraphics -L/usr/local/Cellar/libxcb/1.14_1/lib -lxcb -L/usr/local/Cellar/libxcb/1.14_1/lib -lxcb-shm -L/usr/local/Cellar/libxcb/1.14_1/lib -lxcb-shape -L/usr/local/Cellar/libxcb/1.14_1/lib -lxcb-xfixes -L/usr/local/lib -lSDL2
