...
This is a deprecated option to set the segment length in microseconds, use I<seg_duration> instead.
...
Applicable only when I<streaming> and I<hls_playlist> options are enabled.
